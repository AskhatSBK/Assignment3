...
describe("AITU_ABA_SE2323 Token", function () {
    let Token, token, owner, addr1, addr2;

    beforeEach(async function () {
        [owner, addr1, addr2] = await ethers.getSigners();
        Token = await ethers.getContractFactory("AITU_ABA_SE2323");
    ...
    it("Should have correct name, symbol, and initial supply", async function () {
        ...
        expect(await token.name()).to.equal("AstanaITUniversity_SE2323");
        expect(await token.symbol()).to.equal("ABA2323");
    ...
    it("Should reject zero initial supply", async function () {
        const TokenZeroSupply = await ethers.getContractFactory("AITU_ABA_SE2323");
