...
contract AITU_ABA_SE2323 is ERC20 {
    ...
    constructor(uint256 _initialSupply) ERC20("AstanaITUniversity_SE2323", "ABA2323") {
...
// "Add functions to retrieve and display transaction information"
// ✅ Implemented via the getRecentTransfer() function, which returns the sender, receiver, amount, and timestamp of the most recent transaction.

// "Create a function to return the block timestamp of the latest transaction in a human-readable format"
// ✅ Implemented via the getFormattedTimestamp() function, which converts the timestamp into a dd/mm/yyyy hh:mm format using the formatTimestamp() helper function.

// "Implement a function to retrieve the address of the transaction sender"
// ✅ Implemented via the getTransferSender() function, which returns the recentTransfer.sender.

// "Develop a function to retrieve the address of the transaction receiver"
// ✅ Implemented via the getTransferReceiver() function, which returns the recentTransfer.receiver.$ npx hardhat compile